...
//asks for words to fill first story
function playOne() {
...
//asks for words to fill second story
function playTwo() {
  alert(`Let's start by typing in some nouns, objects, and whatnots! Have fun!`);
...
function startOne(obj) {
  alert(
  `It was a ${storyOne.adj1} summer day. ${storyOne.person} and I were excited to go camping at ${storyOne.place}. 
  It was my first time going there. I packed my favorite ${storyOne.clothing}. It is ${storyOne.adj2} and ${storyOne.adj3}. 
  Perfect for camping! On the road we went in our ${storyOne.adj4} ${storyOne.adj5} van! 
  We were listening to ${storyOne.song} all the way down. The drive was about 5 hours but it was so worth it. 
  When we got there, we unpacked the van. I ${storyOne.pastTenseVerb1} to the room I was staying in with my ${storyOne.noun1}. 
  The next thing I knew, ${storyOne.noun2} came and ${storyOne.pastTenseVerb2} ${storyOne.pastTenseVerb3} outside. 
  I saw ${storyOne.noun3}. It was ${storyOne.noun4}. Over the next few days I got to ${storyOne.verb1}, ${storyOne.verb2}, and ${storyOne.verb3}. 
  My camping trip was ${storyOne.adj6}.`
  );
  return startGame();
}
...
function startTwo(obj) {
  alert(
    `We had run out of ${storyTwo.noun1} so I had to go down to the local ${storyTwo.noun2} to buy more of it. 
    On the way I met my ${storyTwo.posAdj} neighbor and their ${storyTwo.negAdj} spouse. 
    They ${storyTwo.pastVerb} for so long I thought I was just going to ${storyTwo.verb1} right there on the spot. 
    They both finally left my ${storyTwo.noun3} and I could go back to my task. 
    When I finally arrived at my destination, they were all out of what I needed so I bought ${storyTwo.noun4} instead. 
    Turn out making substitutions in a recipe was a bad idea and my entire family round up very ${storyTwo.verb2}.`
    );
  return startGame();
}
